  ...
  <el-row class="app-container">
    <CommonQuery>
      <template slot="button1">
        <el-button @click="handleCreate" icon="el-icon-plus" size="mini" type="primary" v-waves>新建</el-button>
        <el-button
    ...
    >
      ...
      <el-table-column align="center" label="Unicode" prop="unicode"></el-table-column>
      <el-table-column align="center" label="Number" prop="number"></el-table-column>
      <el-table-column align="center" label="Value" prop="value"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        unicode: [{ required: true, message: '此项为必填项', trigger: 'change' }],
