  ...
  <el-row class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="stepCrawlFlag" top="1vh" width="1600px">
      <el-row :gutter="1">
        ...
        <el-col :span="2">
          <el-button :disabled="preSaleWantToSeeListData.length===0" @click="beginToCrawRankingListMovieData" type="primary"
                     v-if="!crawlingFlag">
          ...
          <el-row>
            <el-col :span="24">
              <el-card shadow="never">
                <el-progress :percentage="rankingListData.length!==0?Math.floor(crawlingCount/rankingListData.length*100):0" :stroke-width="20"
                             :text-inside="true"
