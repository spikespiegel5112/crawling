...
const _createRecord = (requestBody, timestamp) => {
  ...
  return new Promise((resolve, reject) => {
    MaoyanRecordModel.create(requestBody)
      .then((result) => {
        resolve(result);
      })
      .catch((error) => {
...
const saveMultipleMaoyanRankingListRecord = (req, res, next) => {
  ...
  _createMultipleMaoyanRankingListRecordPromise(requestBody, timestamp)
    .then((response) => {
      res.status(200).json({
        data: response,
      });
...
const _createMultipleMaoyanRankingListRecordPromise = (
  requestBody,
  timestamp
) => {
  let _timestamp = timestamp;
  ...
  return new Promise((resolve, reject) => {
    MaoyanRecordModel.bulkCreate(requestBody.reverse())
      .then((result) => {
        // console.log(result);
        resolve(result);
      })
          ...
          if (Number(item).toString() !== "NaN") {
            ...
            if (
              ...
              result.push({
                title: find(
                  $,
                  "#ranks-list .row:eq(" + item + ") .first-line"
                ).text(),
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const rawData = {
        ...
        preSaleBoxInfo: find(
          $,
          ".info-presell-block .info-detail-col:eq(0) .detail-num"
        ).text(),
      };
...
const crawlRankingListMoreSections = async (req, res, next) => {
  _crawlRankingListMoreSectionsPromise(req, res, next)
    .then((response) => {
      console.log(
        "crawlRankingListMoreSections+++++++++++++++++++++++++++++++",
        response
      );
      res.status(200).json({
        data: response,
...
const _crawlRankingListMoreSectionsPromise = (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const rawData = {
        description: $(
          ".detail-section .detail-item .detail-block-content"
        ).text(),
      };
      ...
      console.log(
        "_crawlRankingListMoreSectionsPromise result+++++++++",
        result
      );
...
const crawlRankingListBoxOfficeDetail = async (req, res, next) => {
  _crawlRankingListBoxOfficeDetailPromise(req, res, next)
    .then((response) => {
      console.log(
        "_crawlRankingListBoxOfficeDetailPromise+++++++++++++++++++++++++++++++",
        response
      );
      res.status(200).json({
        data: response,
...
const crawlRankingListBoxOfficePremiere = async (req, res, next) => {
  _crawlRankingListBoxOfficePremierePromise(req, res, next)
    .then((response) => {
      console.log(
        "_crawlRankingListBoxOfficeDetailPromise+++++++++++++++++++++++++++++++",
        response
...
const _crawlRankingListBoxOfficePremierePromise = async (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const rawData = {
        preSaleBoxInfo:
          find($, ".box-summary .box-item:eq(0) .box-num").text() +
          find($, ".box-summary .box-item:eq(0) .box-unit").text(),
        preSaleShowRate: find(
          $,
          ".box-summary .box-item:eq(1) .box-num"
        ).text(),
        preSaleShowInfo:
          find($, ".box-summary .box-item:eq(2) .box-num").text() +
          find($, ".box-summary .box-item:eq(2) .box-unit").text(),
      };
      const result = {
        preSaleBoxInfo: rawData.preSaleBoxInfo,
      ...
      console.log(
        "_crawlRankingListBoxOfficeGlobalPromise result+++++++++",
        result
      );
...
const crawlRankingListBoxOfficeGlobal = async (req, res, next) => {
  _crawlRankingListBoxOfficeGlobalPromise(req, res, next)
    .then((response) => {
      console.log(
        "_crawlRankingListBoxOfficeGlobalPromise+++++++++++++++++++++++++++++++",
        response
      );
      res.status(200).json({
        data: response,
...
const crawlRankingListRating = async (req, res, next) => {
  _crawlRankingListRatingPromise(req, res, next)
    .then((response) => {
      console.log(
        "_crawlRankingListRatingPromise+++++++++++++++++++++++++++++++",
        response
      );
      res.status(200).json({
        data: response,
...
const crawlRankingListPremiereBox = async (req, res, next) => {
  _crawlRankingListPremiereBoxPromise(req, res, next)
    .then((response) => {
      console.log(
        "_crawlRankingListPremiereBoxPromise+++++++++++++++++++++++++++++++",
        response
      );
      res.status(200).json({
        data: response,
...
const _crawlRankingListPremiereBoxPromise = async (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      console.log(
        "commonController.crawlPagePromise(req, res, next)+++++",
        req.query
      );
      // console.log('commonController.crawlPagePromise', response);
      const $ = response.$;
      ...
      const rawData = {
        preSaleBoxInfo:
          find($, ".box-item:eq(0) .box-num").text() +
          find($, ".box-item:eq(0) .box-unit").text(),
        // 预售排片占比
...
const _crawlRankingListBoxOfficeDetailPromise = async (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const rawData = {
        boxInfo:
          (await commonController.parseDecimalPromise(
            find($, ".box-summary:eq(0) .box-item:eq(0) .box-num .cs").html(),
            base64
          )) + find($, ".box-summary:eq(0) .box-item:eq(0) .box-unit").text(),
        boxInfoFirstWeek:
          (await commonController.parseDecimalPromise(
            find($, ".box-summary:eq(0) .box-item:eq(1) .box-num .cs").html(),
            base64
          )) + find($, ".box-summary:eq(0) .box-item:eq(1) .box-unit").text(),
        boxInfoFirstDay:
          (await commonController.parseDecimalPromise(
            find($, ".box-summary:eq(0) .box-item:eq(1) .box-num .cs").html(),
            base64
          )) + find($, ".box-summary:eq(0) .box-item:eq(2) .box-unit").text(),
        splitBoxInfo:
          (await commonController.parseDecimalPromise(
            find($, ".box-summary:eq(1) .box-item:eq(0) .box-num .cs").html(),
            base64
          )) + find($, ".box-summary:eq(1) .box-item:eq(0) .box-unit").text(),
        splitBoxInfoFirstWeek:
          (await commonController.parseDecimalPromise(
            find($, ".box-summary:eq(1) .box-item:eq(1) .box-num .cs").html(),
            base64
          )) + find($, ".box-summary:eq(1) .box-item:eq(1) .box-unit").text(),
        splitBoxInfoFirstDay:
          (await commonController.parseDecimalPromise(
            find($, ".box-summary:eq(1) .box-item:eq(1) .box-num .cs").html(),
            base64
          )) + find($, ".box-summary:eq(1) .box-item:eq(2) .box-unit").text(),
...
const _crawlRankingListBoxOfficeGlobalPromise = async (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const rawData = {
        globalBoxInfo:
          find($, ".section-sum .desc:eq(0) .value span:eq(0)").text() +
          find($, ".section-sum .desc:eq(0) .unit").text(),
        northAmericaBoxInfo:
          find($, ".section-sum .desc:eq(1) .value span:eq(0)").text() +
          find($, ".section-sum .desc:eq(1) .unit").text(),
        imdbRating:
          find($, ".section-sum .desc:eq(1) .value span").text() +
          find($, ".section-sum .desc:eq(2) .unit").text(),
      };
      const result = {
...
const _crawlRankingListRatingPromise = async (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      const rawData = {
        rating: await commonController.parseDecimalPromise(
          $(".score-num .cs").html(),
          base64
        ),
        numOfRating: await commonController.parseDecimalPromise(
          $(".score-count .cs").html(),
          base64
        ),
        rating9To10: find(
          $,
          ".movie-comments .distribute-item:eq(0) .distribute-val"
        ).text(),
        rating7To8: find(
          $,
          ".movie-comments .distribute-item:eq(1) .distribute-val"
        ).text(),
        rating5To6: find(
          $,
          ".movie-comments .distribute-item:eq(2) .distribute-val"
        ).text(),
        rating3To4: find(
          $,
          ".movie-comments .distribute-item:eq(3) .distribute-val"
        ).text(),
        rating1To2: find(
          $,
          ".movie-comments .distribute-item:eq(4) .distribute-val"
        ).text(),
        ratingByGenderMale: await commonController.parseDecimalPromise(
          $(".persona-gender-male .persona-item-value .cs").html(),
          base64
        ),
        ratingByGenderFemale: await commonController.parseDecimalPromise(
          $(".persona-gender-female .persona-item-value .cs").html(),
          base64
        ),
        ratingByAge20:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(2) .cs").html(),
            base64
          )) + "%",
        ratingByAge20To24:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(3) .cs").html(),
            base64
          )) + "%",
        ratingByAge25To29:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(4) .cs").html(),
            base64
          )) + "%",
        ratingByAge30To34:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(5) .cs").html(),
            base64
          )) + "%",
        ratingByAge35To39:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(6) .cs").html(),
            base64
          )) + "%",
        ratingByAge40:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(7) .cs").html(),
            base64
          )) + "%",
        ratingByTier1:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(8) .cs").html(),
            base64
          )) + "%",
        ratingByTier2:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(9) .cs").html(),
            base64
          )) + "%",
        ratingByTier3:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(10) .cs").html(),
            base64
          )) + "%",
        ratingByTier4:
          (await commonController.parseDecimalPromise(
            find($, ".persona-item-value:eq(11) .cs").html(),
            base64
          )) + "%",
      };
...
const _crawlRankingListWantToSeePortraitPromise = (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    req.query = Object.assign(req.query, {
      address: encodeURI(
        req.query.address + "?city_tier=0&city_id=0&cityName=全国"
      ),
    });
    ...
    try {
      ...
      console.log(
        "_crawlRankingListWantToSeePortraitPromise(req, res, next)+++++",
        req.query
      );
      // res.status(200).json({
      // 	data: req.query
      ...
      const isEmpty =
        $(".bar-group .single-bar text").text() === "" ? true : false;

      const rawData = {
        wantToSeeByGenderMale:
          (await commonController.parseDecimalPromise(
            _trimData(find($, ".stackcolumn-desc .cs:eq(0)")),
            base64
          )) + "%",
        wantToSeeByGenderFemale:
          (await commonController.parseDecimalPromise(
            _trimData(find($, ".stackcolumn-desc .cs:eq(1)")),
            base64
          )) + "%",
        wantToSeeByAge20: find($, ".bar-group .single-bar text:eq(0)").text(),
        wantToSeeByAge20To24: find(
          $,
          ".bar-group .single-bar text:eq(1)"
        ).text(),
        wantToSeeByAge25To29: find(
          $,
          ".bar-group .single-bar text:eq(2)"
        ).text(),
        wantToSeeByAge30To34: find(
          $,
          ".bar-group .single-bar text:eq(3)"
        ).text(),
        wantToSeeByAge35To39: find(
          $,
          ".bar-group .single-bar text:eq(4)"
        ).text(),
        wantToSeeByAge40: find($, ".bar-group .single-bar text:eq(5)").text(),
        wantToSeeByTier1: find(
          $,
          ".linebars-list .linebars-item .linebars-value:eq(0)"
        ).text(),
        wantToSeeByTier2: find(
          $,
          ".linebars-list .linebars-item .linebars-value:eq(1)"
        ).text(),
        wantToSeeByTier3: find(
          $,
          ".linebars-list .linebars-item .linebars-value:eq(2)"
        ).text(),
        wantToSeeByTier4: find(
          $,
          ".linebars-list .linebars-item .linebars-value:eq(3)"
        ).text(),
        // request: req.query,
        // html: response.body
      };
...
const crawlRankingList = async (req, res, next) => {
  ...
  _crawlRankingListPromise(req, res, next)
    .then((response) => {
...
const crawlRankingListByYear = async (req, res, next) => {
  _crawlRankingListbyYearPromise(req, res, next)
    .then((response) => {
      res.status(200).json({
        data: response,
      });
        ...
        Object.keys(listItem.find(".first-line")).forEach((item, index) => {
          if (Number(item).toString() !== "NaN") {
            ...
            if (
              ...
              result[index].title =
                listItem.find(".first-line")[item].children[0].data;
            }
          } else {
            offset++;
          }
...
const crawlRankingListDetail = async (req, res, next) => {
  return new Promise((resolve, reject) => {
    _crawlRankingListDetailPromise(req, res, next)
      .then((response) => {
        console.log(
          "_crawlRankingListDetailPromise+++++++++++++++++++++++++++++++",
          response
        );
        res.status(200).json({
          data: response,
...
const crawlRankingListWantToSeePortrait = async (req, res, next) => {
  return new Promise((resolve, reject) => {
    _crawlRankingListWantToSeePortraitPromise(req, res, next)
      .then((response) => {
        console.log(
          "_crawlRankingListWantToSeePortrait+++++++++++++++++++++++++++++++",
          response
        );
        res.status(200).json({
          data: response,
...
const crawlAndSave = (req, res, next) => {
  ...
  commonController
    ...
    .then((response) => {
      ...
      let count = 0;
      const loop = () => {
        _createRecord(response.data.list[count], timestamp)
          .then((response2) => {
...
const deleteRecords = (req, res, next) => {
  ...
  if (idBody instanceof Array) {
    idBody.forEach((item, index) => {
      MaoyanRecordModel.findByPk(item)
        .then(async (response) => {
    ...
    MaoyanRecordModel.findByPk(idBody)
      .then((result) => {
        console.log(result);
        result.destroy().then(() => {
          if (index + 1 === req.body.id.length) {
...
exports.crawlRankingListPremiereBox = crawlRankingListPremiereBox;
exports.saveOneRankingListRecord = saveOneRankingListRecord;
exports.saveMultipleMaoyanRankingListRecord =
  saveMultipleMaoyanRankingListRecord;
